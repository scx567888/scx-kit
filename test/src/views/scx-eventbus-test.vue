...
import {ScxBaseApiUrl, ScxEventBus} from "../../../scx-kit.js";

export default {
  name: "scx-eventbus-test",
  setup() {
    const scxBaseApiUrl = new ScxBaseApiUrl("http://127.0.0.1:8080/");
    const scxEventBus = new ScxEventBus(scxBaseApiUrl);
